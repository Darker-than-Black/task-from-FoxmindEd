...
if (!class_exists('\\BootstrapBasic4\\BootstrapBasic4')) {
    ...
    class BootstrapBasic4
    {
        ...
        public function enqueueScriptsAndStyles()
        {
            ...
            wp_enqueue_style('foxmind.style', get_template_directory_uri() . '/assets/css/foxmind.style.css', array());
            ...
            wp_enqueue_script('foxmind.mobile', get_template_directory_uri() . '/assets/js/foxmind.mobile.js', array('jquery'), false, true);
            wp_enqueue_script('foxmind.main', get_template_directory_uri() . '/assets/js/foxmind.main.js', array('jquery'), false, true);
